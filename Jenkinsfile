pipeline {
    ...
    environment {
        ...
        FRONTEND_ARGS="-p HTTP_PORT=8080 -p HTTP_SCHEMA=http TERMINATION_TYPE='Edge' -p REDIRECT_URL=http://${VANITY_URL} -p VANITY_URL=${VANITY_URL} -p SSO_HOST=sso-dev.pathfinder.gov.bc.ca"
