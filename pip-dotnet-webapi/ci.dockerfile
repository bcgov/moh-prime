...
# RUN dotnet build "pip.csproj" -c Release -o /tmp/app/out
RUN dotnet publish "pip.csproj" -c Release -o /tmp/app/out /p:MicrosoftNETPlatformLibrary=Microsoft.NETCore.App
