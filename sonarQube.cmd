...
coverlet ./prime-dotnet-webapi-tests/bin/Debug/netcoreapp2.2/PrimeTests.dll -f opencover -o ./BuildReports/Coverage/coverage --target "dotnet" --targetargs 'test . --no-build --logger "trx;LogFileName=TestResults.trx" --logger "xunit;LogFileName=TestResults.xml" --results-directory ./BuildReports/UnitTests' 
