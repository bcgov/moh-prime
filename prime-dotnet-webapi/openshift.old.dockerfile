#FROM image-registry.openshift-image-registry.svc:5000/9c33a9-${OC_APP}/dotnet-22-rhel7 AS build
#FROM registry.redhat.io/dotnet/dotnet-22-rhel7 AS build
FROM image-registry.openshift-image-registry.svc:5000/9c33a9-tools/dotnet-30 AS build
...
FROM image-registry.openshift-image-registry.svc:5000/9c33a9-tools/dotnet-30-runtime-rhel7 AS runtime
