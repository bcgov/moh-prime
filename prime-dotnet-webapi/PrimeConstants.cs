...
namespace Prime
{
    public static class PrimeConstants
    {
        ...
        // Aries Prime Agent
        public readonly static string VERIFIABLE_CREDENTIAL_API_URL = Environment.GetEnvironmentVariable("VERIFIABLE_CREDENTIAL_API_URL") ?? "http://52.250.9.144:8000/api/";
