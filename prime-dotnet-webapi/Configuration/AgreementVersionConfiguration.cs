        ...
        public override IEnumerable<AgreementVersion> SeedData
        {
            get
            {
                return new[] {
                    ...
                    new AgreementVersion { Id = 12, AgreementType = AgreementType.PharmacyOboTOA,                Text = "pharmacy-obo-toa-v1.html",       EffectiveDate = SEEDING_DATE,                                CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                };
            }
        }
