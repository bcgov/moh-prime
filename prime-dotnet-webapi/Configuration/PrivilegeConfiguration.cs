        ...
        public override ICollection<Privilege> SeedData
        {
            get
            {
                return new[] {
                    ...
                    new Privilege { Id = 17, PrivilegeGroupCode = 4, TransactionType = "RU",  Description = "Can be RU (OBO)", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    new Privilege { Id = 18, PrivilegeGroupCode = 4, TransactionType = "OBO", Description = "Can be OBO (RU)", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    new Privilege { Id = 19, PrivilegeGroupCode = 5, TransactionType = "RU with OBOs", Description = "Registered User that can have OBOs", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE }
                };
            }
        }
