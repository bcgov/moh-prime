    ...
    public class PrivilegeConfiguration : IEntityTypeConfiguration<Privilege>
    {
        public void Configure(EntityTypeBuilder<Privilege> builder)
        {
            ...
            builder.HasData(
                ...
                new Privilege { Id = 18, PrivilegeGroupCode = 5, TransactionType = "OBO", Description = "Can be OBO (RU)", CreatedTimeStamp = SeedConstants.SEEDING_DATE, UpdatedTimeStamp = SeedConstants.SEEDING_DATE }
            );
        }
    }
}
