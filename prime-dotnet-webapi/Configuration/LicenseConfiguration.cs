        ...
        public override IEnumerable<License> SeedData
        {
            get
            {
                return new[] {
                    ...
                    new License { Code = 11, Weight = 18, Prefix = "91", Manual = false, Validate = true,  NamedInImReg = false, LicensedToProvideCare = true,  Name = "Educational - Medical Student"                       },
                    ...
                    new License { Code = 50, Weight = 3,  Prefix = "96", Manual = true,  Validate = true,  NamedInImReg = true,  LicensedToProvideCare = true,  PrescriberIdType = PrescriberIdType.Mandatory, Name = "Temporary Nurse Practitioner (Special Event)"           },
                    ...
                    new License { Code = 38, Weight = 8,  Prefix = "R9", Manual = true,  Validate = false, NamedInImReg = false, LicensedToProvideCare = true,  PrescriberIdType = PrescriberIdType.Optional,  Name = "Temporary Registered Nurse (Special Event)"             },
                    ...
                    new License { Code = 44, Weight = 17, Prefix = "Y9", Manual = true,  Validate = false, NamedInImReg = false, LicensedToProvideCare = true,  PrescriberIdType = PrescriberIdType.Optional,  Name = "Temporary Registered Psychiatric Nurse (Special Event)" },
                    ...
                    new License { Code = 56, Weight = 24, Prefix = "L9", Manual = true,  Validate = false, NamedInImReg = false, LicensedToProvideCare = true,                                                 Name = "Temporary Licensed Practical Nurse (Special Event)"     },
                    ...
                    new License { Code = 57, Weight = 26, Prefix = "96", Manual = true,  Validate = true,  NamedInImReg = true,  LicensedToProvideCare = false,                                                Name = "Non-Practicing Licensed Nurse Practitioner"             },
                    new License { Code = 58, Weight = 27, Prefix = "96", Manual = true,  Validate = true,  NamedInImReg = true,  LicensedToProvideCare = true,                                                 Name = "Temporary Nurse Practitioner (time-limited)"            },
