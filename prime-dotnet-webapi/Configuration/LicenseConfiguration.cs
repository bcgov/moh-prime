        ...
        public override IEnumerable<License> SeedData
        {
            get
            {
                return new[] {
                    ...
                    new License { Code = 59, Weight = 25, Manual = true,  Validate = false, NamedInImReg = false, LicensedToProvideCare = true,  Name = "Podiatrists", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    ...
                    new License { Code = 32, Weight = 6,  Manual = false, Validate = false, NamedInImReg = false, LicensedToProvideCare = true,  Name = "Practicing Registered Nurse", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    new License { Code = 33, Weight = 7,  Manual = false, Validate = false, NamedInImReg = false, LicensedToProvideCare = true,  Name = "Provisional Registered Nurse", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    ...
                    new License { Code = 41, Weight = 15, Manual = false, Validate = false, NamedInImReg = false, LicensedToProvideCare = true,  Name = "Practicing Registered Psychiatric Nurse", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    ...
                    new License { Code = 45, Weight = 18, Manual = false, Validate = false, NamedInImReg = false, LicensedToProvideCare = true,  Name = "Temporary Registered Psychiatric Nurse (Emergency)", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
