        ...
        public override ICollection<License> SeedData
        {
            get
            {
                return new[] {
                    ...
                    new License { Code = 8,  Weight = 5, Manual = true, Name = "Conditional - Practice Limitations", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    new License { Code = 9,  Weight = 6, Manual = true, Name = "Conditional - Practice Setting", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    ...
                    new License { Code = 11, Weight = 14, Manual = false, Name = "Educational - Medical Student", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    new License { Code = 12, Weight = 15, Manual = false, Name = "Educational - Postgraduate Resident", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    new License { Code = 13, Weight = 16, Manual = false, Name = "Educational - Postgraduate Resident Elective", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    new License { Code = 14, Weight = 17, Manual = false, Name = "Educational - Postgraduate Fellow", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    new License { Code = 15, Weight = 18, Manual = false, Name = "Educational - Postgraduate Trainee", CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
