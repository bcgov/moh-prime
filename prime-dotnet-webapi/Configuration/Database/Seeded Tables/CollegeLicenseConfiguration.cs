        ...
        public override IEnumerable<CollegeLicense> SeedData
        {
            get
            {
                return new[] {
                    ...
                    new CollegeLicense { CollegeCode = 1, LicenseCode = 87, Discontinued = true },
                    new CollegeLicense { CollegeCode = 1, LicenseCode = 88, Discontinued = true },
                    new CollegeLicense { CollegeCode = 1, LicenseCode = 89, Discontinued = true },
                    ...
                    new CollegeLicense { CollegeCode = 3, LicenseCode = 34,  CollegeLicenseGroupingCode = 2, Discontinued = true },
                    ...
                    new CollegeLicense { CollegeCode = 3, LicenseCode = 37,  CollegeLicenseGroupingCode = 2, Discontinued = true },
                    ...
                    new CollegeLicense { CollegeCode = 3, LicenseCode = 43,  CollegeLicenseGroupingCode = 3, Discontinued = true },
                    ...
                    new CollegeLicense { CollegeCode = 3, LicenseCode = 49,  CollegeLicenseGroupingCode = 4, Discontinued = true },
                    ...
                    new CollegeLicense { CollegeCode = 3, LicenseCode = 54,  CollegeLicenseGroupingCode = 1, Discontinued = true },
                    ...
                    new CollegeLicense { CollegeCode = 3, LicenseCode = 63,  CollegeLicenseGroupingCode = 5, Discontinued = true },
                    new CollegeLicense { CollegeCode = 3, LicenseCode = 69,  CollegeLicenseGroupingCode = 5, Discontinued = true },
