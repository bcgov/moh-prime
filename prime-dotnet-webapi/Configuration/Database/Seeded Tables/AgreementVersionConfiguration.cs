        ...
        public override IEnumerable<AgreementVersion> SeedData
        {
            get
            {
                return new[] {
                    ...
                    new AgreementVersion { Id = 18, AgreementType = AgreementType.PharmacyTechRuNoOboTOA,        Text =  "pharmacy-tech-ru-no-obo-toa-v1.html", EffectiveDate = SEEDING_DATE,                                CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                };
            }
        }
