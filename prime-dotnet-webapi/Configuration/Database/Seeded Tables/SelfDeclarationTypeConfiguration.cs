        ...
        public override IEnumerable<SelfDeclarationType> SeedData
        {
            get
            {
                return new[] {
                    ...
                    new SelfDeclarationType { Code = (int)SelfDeclarationTypeCode.DisciplinaryAction,    Name = "Has Disciplinary Action"   , SortingNumber = 5 },
                    new SelfDeclarationType { Code = (int)SelfDeclarationTypeCode.PharmaNetSuspended,    Name = "Has PharmaNet Suspended"   , SortingNumber = 4 },

                    new SelfDeclarationType { Code = (int)SelfDeclarationTypeCode.RegistrationSuspended_DeviceProvider, Name = "Has PharmaNet Suspended - Device Provider"   , SortingNumber = 3 },
                };
            }
        }
    }
