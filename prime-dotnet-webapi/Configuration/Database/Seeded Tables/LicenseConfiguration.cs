        ...
        public override IEnumerable<License> SeedData
        {
            get
            {
                return new[] {
                    ...
                    new License { Code = 87, Weight = 1, Name = "Dental Hygienists" },
                    new License { Code = 88, Weight = 2, Name = "Dental Hygiene Practitioner" },
                    new License { Code = 89, Weight = 3, Name = "Full Dentist" },
                    new License { Code = 90, Weight = 4, Name = "Limited Dentist (Restricted to Specialty)" },
                    new License { Code = 91, Weight = 5, Name = "Limited (Academic) Dentist" },
                    new License { Code = 92, Weight = 6, Name = "Limited (Educational and Volunteer) Dentist" },
                    new License { Code = 93, Weight = 7, Name = "Limited (Armed Forces/Government) Dentist" },
