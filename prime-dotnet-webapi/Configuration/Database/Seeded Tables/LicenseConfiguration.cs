        ...
        public override IEnumerable<License> SeedData
        {
            get
            {
                return new[] {
                    ...
                    new License { Code = 5,  Weight = 2,  Name = "Provisional - Family"                                },
                    new License { Code = 18, Weight = 3, Name = "Emergency - Family"                                  },
                    new License { Code = 90, Weight = 4, Name = "Assessment - Family"                                 },
                    new License { Code = 183, Weight = 5, Name = "Restricted - Family"                                },
                    new License { Code = 2,  Weight = 6,  Name = "Full - Specialty"                                    },
                    new License { Code = 6,  Weight = 7,  Name = "Provisional - Specialty"                             },
                    new License { Code = 19, Weight = 8, Name = "Emergency - Specialty"                               },
                    new License { Code = 91, Weight = 9, Name = "Assessment - Specialty"                              },
                    new License { Code = 184, Weight = 10, Name = "Restricted - Specialty"                             },
                    new License { Code = 12, Weight = 11, Name = "Educational - Postgraduate Resident"                 },
                    new License { Code = 179,Weight = 12, Name = "Educational - Postgraduate Resident Clinical Associate"},
                    new License { Code = 13, Weight = 13, Name = "Educational - Postgraduate Resident Elective"        },
                    new License { Code = 14, Weight = 14, Name = "Educational - Postgraduate Fellow"                   },
                    new License { Code = 15, Weight = 15, Name = "Educational - Postgraduate Trainee"                  },
                    new License { Code = 11, Weight = 16, Name = "Educational - Medical Student"                       },
                    new License { Code = 92, Weight = 17, Name = "Certified Physician Assistant"                       },
                    new License { Code = 7,  Weight = 18, Name = "Academic"                                            },
                    new License { Code = 23, Weight = 19, Name = "Administrative"                                      },
                    new License { Code = 180,Weight = 20, Name = "Associate"                                           },
                    new License { Code = 16, Weight = 21,  Name = "Clinical Observership"                               },
                    new License { Code = 10, Weight = 22,  Name = "Conditional - Disciplined"                           },
                    new License { Code = 4,  Weight = 23, Name = "Osteopathic"                                         },
                    new License { Code = 20, Weight = 24, Name = "Retired - Life"                                      },
                    new License { Code = 3,  Weight = 25, Name = "Special"                                             },
                    new License { Code = 22, Weight = 26,  Name = "Surgical Assistant"                                  },
                    new License { Code = 17, Weight = 27, Name = "Visitor"                                             },
                    new License { Code = 59, Weight = 28, Name = "Full - Podiatric Surgeon"                            },
                    new License { Code = 65, Weight = 29, Name = "Educational - Podiatric Surgeon Student (Elective)"  },
                    new License { Code = 66, Weight = 30, Name = "Educational - Podiatric Surgeon Resident (Elective)" },
                    new License { Code = 67, Weight = 31, Name = "Conditional - Podiatric Surgeon Disciplined"         },
                    new License { Code = 9,  Weight = 32,  Name = "Conditional - Practice Setting"                      },
                    new License { Code = 8,  Weight = 33,  Name = "Conditional - Practice Limitations"                  },
                    new License { Code = 24, Weight = 34, Name = "Assessment"                                          },
                    new License { Code = 21, Weight = 34, Name = "Temporarily Inactive"                                },
                    new License { Code = 87, Weight = 35, Name = "Associate - Acute Care"                              },
                    new License { Code = 88, Weight = 36, Name = "Associate - Community Primary Care"                  },
                    new License { Code = 89, Weight = 37, Name = "USA Certified"                                       },

                    // Pharmacy
                    new License { Code = 25, Weight = 10, Name = "Full Pharmacist"                    },
                    new License { Code = 27, Weight = 20, Name = "Temporary Pharmacist"               },
                    new License { Code = 181, Weight = 30, Name = "Provisional Pharmacist"            },
                    new License { Code = 28, Weight = 40, Name = "Student Pharmacist"                 },
                    new License { Code = 29, Weight = 50, Name = "Pharmacy Technician"                },
                    new License { Code = 68, Weight = 60, Name = "Temporary Pharmacy Technician"      },
                    new License { Code = 182, Weight = 70, Name = "Provisional Pharmacy Technician"   },
                    new License { Code = 26, Weight = 100, Name = "Limited Pharmacist"                 },
                    new License { Code = 178, Weight = 101, Name = "Temporary Limited Pharmacist"      },
                    new License { Code = 30, Weight = 102, Name = "Non-Practicing Pharmacist"          },
                    new License { Code = 31, Weight = 103, Name = "Non-Practicing Pharmacy Technician" },

                    // BCCNM
                    // NP
                    new License { Code = 47,  Weight = 1,  Name = "Practicing Nurse Practitioner"                          },
                    new License { Code = 51,  Weight = 2,  Name = "Temporary Nurse Practitioner (Emergency)"               },
                    new License { Code = 48,  Weight = 3,  Name = "Provisional Nurse Practitioner"                         },
                    new License { Code = 49,  Weight = 4,  Name = "Non-Practicing Nurse Practitioner"                      },
                    // RN/LGN
                    new License { Code = 32,  Weight = 11, Name = "Practicing Registered Nurse"                            },
                    new License { Code = 39,  Weight = 12, Name = "Temporary Registered Nurse (Emergency)"                 },
                    new License { Code = 175, Weight = 13, Name = "RN – Multijurisdictional"                               },
                    new License { Code = 33,  Weight = 14, Name = "Provisional Registered Nurse"                           },
                    new License { Code = 40,  Weight = 15, Name = "Employed Student Nurse"                                 },
                    new License { Code = 35,  Weight = 16, Name = "Practicing Licensed Graduate Nurse"                     },
                    new License { Code = 36,  Weight = 17, Name = "Provisional Licensed Graduate Nurse"                    },
                    new License { Code = 34,  Weight = 18, Name = "Non-Practicing Registered Nurse"                        },
                    ...
                    new License { Code = 45,  Weight = 22, Name = "Temporary Registered Psychiatric Nurse (Emergency)"     },
                    new License { Code = 176, Weight = 23, Name = "RPN – Multijurisdictional"                              },
                    new License { Code = 42,  Weight = 24, Name = "Provisional Registered Psychiatric Nurse"               },
                    new License { Code = 46,  Weight = 25, Name = "Employed Student Psychiatric Nurse"                     },
                    new License { Code = 43,  Weight = 26, Name = "Non-Practicing Registered Psychiatric Nurse"            },
                    // LPN
                    new License { Code = 52,  Weight = 31, Name = "Practicing Licensed Practical Nurse"                    },
                    new License { Code = 55,  Weight = 32, Name = "Temporary Licensed Practical Nurse (Emergency)"         },
                    new License { Code = 177, Weight = 33, Name = "LPN – Multijurisdictional"                              },
                    new License { Code = 53,  Weight = 34, Name = "Provisional Licensed Practical Nurse"                   },
                    ...
                    new License { Code = 62,  Weight = 42, Name = "Temporary Midwife (Emergency)"                          },
                    new License { Code = 61,  Weight = 43, Name = "Provisional Midwife"                                    },
