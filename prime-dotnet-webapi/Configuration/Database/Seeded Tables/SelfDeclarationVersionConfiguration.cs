        ...
        public override IEnumerable<SelfDeclarationVersion> SeedData
        {
            get
            {
                return new[] {
                    ...
                    // self declaration for device provider
                    new SelfDeclarationVersion { Id = 9,  SelfDeclarationTypeCode = (int)SelfDeclarationTypeCode.Conviction, Text = "Place holder question", EffectiveDate = August10th2023EffectiveDate, CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE, CareSettingCodeStr = "4" },
                };
            }
        }
    }
