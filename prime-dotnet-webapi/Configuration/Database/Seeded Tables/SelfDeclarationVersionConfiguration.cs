        ...
        public override IEnumerable<SelfDeclarationVersion> SeedData
        {
            get
            {
                return new[] {
                    ...
                    new SelfDeclarationVersion { Id = 7,  SelfDeclarationTypeCode = (int)SelfDeclarationTypeCode.DisciplinaryAction, Text = "Has your access to <u>PharmaNet</u> or <u>any other health information system</u>, whether or not electronic and whether or not in British Columbia or another jurisdiction, been suspended or cancelled <u>for a matter involving an “unlawful or improper action”</u>?", EffectiveDate = Dec2022EffectiveDate, CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    new SelfDeclarationVersion { Id = 8,  SelfDeclarationTypeCode = (int)SelfDeclarationTypeCode.PharmaNetSuspended, Text = "Has an employer ever disciplined you, or terminated your employment, for <u>a matter involving an “unlawful or improper action”</u>?  Has a contract for your services ever been terminated <u>for a matter involving an “unlawful or improper action”</u>?", EffectiveDate = Dec2022EffectiveDate, CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                };
            }
        }
    }
