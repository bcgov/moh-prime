        ...
        public override ICollection<UserClause> SeedData
        {
            get
            {
                ...
                return new[] {
                    ...
                    new UserClause { Id = 4, Clause = ruClause3, EnrolleeClassification = PrimeConstants.PRIME_RU, EffectiveDate = System.DateTimeOffset.Parse("2020-05-07 00:00:00"), CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE },
                    new UserClause { Id = 5, Clause = oboClause4, EnrolleeClassification = PrimeConstants.PRIME_OBO, EffectiveDate = System.DateTimeOffset.Parse("2020-05-07 00:00:00"), CreatedTimeStamp = SEEDING_DATE, UpdatedTimeStamp = SEEDING_DATE }
                };
            }
        }
    }
