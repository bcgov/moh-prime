        ...
        public override IEnumerable<CollegeLicense> SeedData
        {
            get
            {
                return new[] {
                    ...
                    new CollegeLicense { CollegeCode = 3, LicenseCode = 38, CollegeLicenseGroupingCode = 2 },
                    ...
                    new CollegeLicense { CollegeCode = 3, LicenseCode = 44, CollegeLicenseGroupingCode = 3 },
                    ...
                    new CollegeLicense { CollegeCode = 3, LicenseCode = 50, CollegeLicenseGroupingCode = 4 },
                    ...
                    new CollegeLicense { CollegeCode = 3, LicenseCode = 56, CollegeLicenseGroupingCode = 1 },
                    new CollegeLicense { CollegeCode = 3, LicenseCode = 57, CollegeLicenseGroupingCode = 1 },
                    new CollegeLicense { CollegeCode = 3, LicenseCode = 58, CollegeLicenseGroupingCode = 4 },
