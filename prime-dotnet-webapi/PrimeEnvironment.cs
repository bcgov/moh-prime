...
namespace Prime
{
    public static class PrimeEnvironment
    {
        ...
        {
            public readonly static bool Enabled = bool.Parse(Environment.GetEnvironmentVariable("CHES_ENABLED") ?? "true");
            public readonly static string Url = Environment.GetEnvironmentVariable("CHES_API_URL") ?? "https://ches-master-9f0fbe-dev.pathfinder.gov.bc.ca";
