...
namespace Prime.Migrations
{
    ...
    [Migration("20210914204753_SiteActiveBeforeRegistrationEmailTemplate")]
    partial class SiteActiveBeforeRegistrationEmailTemplate
    {
            ...
            modelBuilder.Entity("Prime.Models.EmailTemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            EmailType = 16,
                            ModifiedDate = new DateTimeOffset(new DateTime(2019, 9, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -7, 0, 0, 0)),
                            Template = @"Thank you for registering your site (SiteID: @Model.Pec) in PRIME.
