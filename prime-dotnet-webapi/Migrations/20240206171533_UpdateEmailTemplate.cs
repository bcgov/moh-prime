    ...
    public partial class UpdateEmailTemplate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyColumn: "Id",
                keyValue: 1,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "The email will be triggered when the adjudicator approves the enrolment, or changes the status to editable.", "To: Enrollee", "PRIME Requires your Attention", "Hello, <p><p> Your PRIME application status has changed since you last viewed it. Please click <a href=\"@Model.Url\">here</a> to log into PRIME and view your status. </p><p> You may need to share your approval email to get your PharmaNet access is set up. Please connect by phone or email if you have any questions. </p><p> Thank you, </p><p> PRIME Support team<br/>1-844-397-7463 <br/> PRIMESupport@gov.bc.ca", "Enrollee Status Change", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });

            migrationBuilder.UpdateData(
                table: "EmailTemplate",
                keyColumn: "Id",
                keyValue: 2,
                columns: new[] { "Description", "ModifiedDate", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "Enrollee send out the Provisioner Link Email and access instructions.", new DateTimeOffset(new DateTime(2019, 9, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -7, 0, 0, 0)), "To: Provisioner, CC: Enrollee", "New Access Request", "<style> .underline { text-decoration: underline; } .list-item-mb { margin-bottom: 0.75rem; } </style>Hello:<br/><br/>@Model.EnrolleeFullName has been approved for private community health practice access to PharmaNet.<br/><br/><strong> To set up their access, forward this notification and the information below to <span class=\"underline\">whoever sets up PharmaNet user accounts. This is usually your PharmaNet software vendor but can also be someone like an IT department or authorized individual</span>. </strong><br/><br/><ol><li class=\"list-item-mb\"> Name of the community health practice ___________________ </li><li class=\"list-item-mb\"> Practice address ___________________ </li><li class=\"list-item-mb\"> PharmaNet site ID, if you have it ___________________</li></ol> If @Model.EnrolleeFullName accesses PharmaNet on behalf of another user, the PharmaNet software vendor should know who they are, and they should be enrolled in PRIME.<br/><br/> Your software vendor can find @Model.EnrolleeFullName's details by following this link: <a href=\"@Model.TokenUrl\">@Model.TokenUrl</a> <strong>This link will expire in 10 days.</strong><br/><br/>Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Community Practice Notification", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 4,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "Enrollee triggered Provisioner Link Email for health authority access.", "To: Provisioner, CC: Enrollee", "New Access Request", "To: PharmNet administrator <br/> <br/> @Model.EnrolleeFullName has been approved for <strong>health authority access to PharmaNet.</strong> <br/> They can now be set up with their PharmaNet access account in your local software. Their <strong>Global PharmaNet ID (GPID)</strong> must be on their account profile. <br/><br/> You can access their GPID here: <a href=\"@Model.TokenUrl\">@Model.TokenUrl</a> <br/> <strong>This link will expire after @Model.ExpiresInDays days</strong>. <br/><br/>Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Health Authority Notification", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 7,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "The email will be triggered when a site is approved.", "To: HLTH.HnetConnection@gov.bc.ca", "[{siteId}] Site Registration Approved", "Hello, <p><p>@Model.DoingBusinessAs with SiteID @Model.Pec has been approved by the Ministry of Health for PharmaNet access. Please notify the PharmaNet software vendor for this site and complete any remaining tasks to activate the site.</p><p>Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "HIBC Site Submission", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 9,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "The email will be triggered when SA uploads a business license and clicks 'Save and Continue'.", "To: Adjudicator", "Site Business Licence Uploaded", "Hello,<p><p> A user has uploaded a business licence to their PharmaNet site registration. @if (!string.IsNullOrWhiteSpace(Model.Url)) { @(\"To access the Business Licence, click this\") <a href=\"@Model.Url\" target=\"_blank\">link</a>@(\".\") } </p> Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Site Business Licence Upload", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 11,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "(To be Deleted - Disabled) When Admin/Ajudicator approves a site.", "To: Site PharmaNet Admin", "Site Registration Approved", "<p> Your site registration has been approved. The site will now be set up and activated in PharmaNet. Your PharmaNet software vendor will be notified when the site has been activated, and you will hear from them when you access PharmaNet. </p> <p> Individuals who will be accessing PharmaNet at your site should enrol in PRIME now if they have not already done so. For more information, please visit <a href=\"https://www.gov.bc.ca/pharmanet/PRIME\" target=\"_blank\">https://www.gov.bc.ca/pharmanet/PRIME</a>. </p> Private community practice only: Physicians or nurse practitioners must indicate in their PRIME profile that they require remote access if needed. They can do this here: <a href=\"https://pharmanetenrolment.gov.bc.ca\" target=\"_blank\">https://pharmanetenrolment.gov.bc.ca</a>. </p> <p> Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Site Approved Pharma Net Administrator", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 13,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "The email will be triggered when a SA or AU submits a site. In the subject line, “{isNewPrefix}” will be replaced with “Priority! New Pharmacy” if the site is marked as a new pharmacy. Also, “{careSetting}” will be replaced with  the site care setting, and “{siteId}” will be replaced with the internal site ID", "To: HLTH.HnetConnection@gov.bc.ca, cc: primesupport@gov.bc.ca", "[{siteId}] {isNewPrefix} PRIME Site Registration Submission - {careSetting}", "Hello,<p> A new PharmaNet site registration has been received. See the attached registration and organization agreement for more information. @if (!string.IsNullOrWhiteSpace(Model.Url)) { @(\"To access the Business Licence, click this\") <a href=\"@Model.Url\" target=\"_blank\">link</a>@(\".\") } <br/><br/> Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Site Registration Submission", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 14,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "The email will be triggered when PRIME admin approves a organization claim.", "To: New SA", "Organization Claim was Approved", "Hello, <p><p>Your claim of the organization @Model.OrganizationName, which the site with SiteID/PEC @Model.ProvidedSiteId is part of, has been approved.  You may now access to site registration for this organization. <br/><br/>You must sign the Organization Agreement before you will be able to update or add any sites. This is a click-to-accept online signature that is linked to your BC Services Card identity. If you are not qualified to accept legal agreements on behalf of your organization, or if your organization does not allow you to sign online agreements, please contact PRIMESupport@gov.bc.ca for further guidance before you proceed further. <p><p> Thank you, <p><p> PRIME Support Team<br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Organization Claim Approval Notification", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 15,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "The email will be triggered when an adjudicator sends a notification from the site overview page for Community Pharmacy or Device Provider site.", "To: Lori.Haggstrom@gov.bc.ca", "PRIME Site Registration review complete", "Hello, <p><p>A PRIME Admin has reviewed the site registration for PEC/SiteID# @Model.Pec. @(!string.IsNullOrWhiteSpace(Model.Note) ? $\"The following notes were added: {Model.Note}\" : \"\") <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Site Reviewed Notification", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 16,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "(To be Deleted) The email will be triggered when a community site is approved and it is marked as 'Active Before Registration'.", "To: SA", "PRIME Site Registration Submission", "Thank you for registering your site (SiteID: @Model.Pec) in PRIME. If you need to update any site information in PRIME, you may log in at any time using your BC Services Card app. Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Site Active Before Registration Submission", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 17,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "(To be Deleted) The email will be triggered when a paper enrolment is submitted.", "To: Enrollee", "Paper Enrolment Submission", "Your request for PharmaNet access has been approved and recorded in PRIME. When it is possible for you to do so, you must enrol in PRIME using your BC Services Card app. <br/> <br/> <strong> Your temporary GPID is @Model.GPID. </strong> <br/> <br/> The first time you log in to PRIME, you should be asked if you have previously received permission to access PharmaNet via an offline process. If you do not see this prompt, please stop your enrolment and contact <a href=\"mailto:PRIMEsupport@gov.bc.ca\" target=\"_top\">PRIMEsupport@gov.bc.ca</a><br/><br/>Thank you,<br/> <br/>PRIME Support <br/>1-844-397-7463<br/><a href=\"mailto:PRIMEsupport@gov.bc.ca\" target=\"_top\">PRIMEsupport@gov.bc.ca</a>", "Paper Enrollee Submission", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 18,
                columns: new[] { "Description", "ModifiedDate", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "(Disabled) The email will be triggered by a batch process, and the email will send to the enrollee, who has not signed the ToA.", new DateTimeOffset(new DateTime(2019, 9, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -7, 0, 0, 0)), "To: Enrollee", "PharmaNet Terms of Access requires signing", "Dear @Model.EnrolleeName, <br/> <br/><p> Please log in to PRIME and accept your PharmaNet terms of access to complete your enrolment.</p><p>You can access PRIME here <a href='@Model.PrimeUrl'>@Model.PrimeUrl</a>.  If you are not directed to the terms of access, select \"Terms of Access\" from the menu on the lefthand side of the screen.</p>Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Enrollee Unsigned Toa", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 19,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "Enrollee send email notification for the absence entry/ period of deactivation.", "To: User entered email", "PRIME Absence Notification", "Hello:<p><p>This is an automated generated email from PRIME. <br/> <br/> @(Model.FirstName + \" \" +  Model.LastName + \" is going to be absent \") @if (Model.End.HasValue) {@(\"from \" + Model.Start.ToShortDateString() + \" to \" + Model.End.Value.ToShortDateString() + \".  Please consider deactivating the user during this period. Any access during this period by the user will be considered as an unauthorized access.\")} else {@(\"indefinitely, starting \" + Model.Start.ToShortDateString() + \". Please deactivate the user on the start date. Any access during this period by the user will be considered as an unauthorized access.\")} Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Enrollee Absence Notification", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 20,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "The email will be triggered daily at 3pm in a batch process. The email will be sent to the enrollee, whose ToA expiry date is coming in 14,  7, 3, 2, 1, 0 days and it is marked as forced renewal.", "To: Enrollee", "PRIME Renewal Required", "Hello @Model.EnrolleeName, <br/> <br/> You are receiving this message as your PharmaNet user status has changed from on-behalf-of user to independent user following changes to legislation governing access to PharmaNet. <br/> <br/> Being an independent PharmaNet user means you will now access PharmaNet as yourself instead of on behalf of another practitioner. <br/> <br/> Log back in to PRIME by @Model.RenewalDate.ToString(\"d MMMM yyyy\") to confirm your profile information and review and accept the user terms of access for independent users. These will automatically be presented to you. This is a requirement for you to maintain access to PharmaNet, as the new terms of access are different from those you may have accepted earlier. <br/> <br/> For information about PRIME, visit the <a href=\"@Model.PrimeUrl\">PRIME web page</a>.  If you have questions or difficulties using PRIME, please contact us at the email address below.<br/> <br/> Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Forced Renewal Notification", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 22,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "Enrollee send out the Provisioner Link Email and access instructions.", "To: Provisioner, CC: Enrollee", "New Access Request", "Hello: <br/> <br/> @Model.EnrolleeFullName has been approved for <strong>device provider access to PharmaNet.</strong> Their PharmaNet access account can now be set up in your local software. You must include their <strong>Global PharmaNet ID (GPID)</strong> on their account profile. You can access their GPID at the link below. <br/> <br/> <a href=\"@Model.TokenUrl\">@Model.TokenUrl</a> <br/> <strong>This link will expire after @Model.ExpiresInDays days</strong>. <br/> <br/> Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Device Provider Notification", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 15,
                columns: new[] { "Template", "UpdatedTimeStamp" },
                values: new object[] { "A PRIME Admin has reviewed the site registration for PEC/SiteID# @Model.Pec. @(!string.IsNullOrWhiteSpace(Model.Note) ? $\"The following notes were added: {Model.Note}\" : \"\")", new DateTimeOffset(new DateTime(2019, 9, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -7, 0, 0, 0)) });
