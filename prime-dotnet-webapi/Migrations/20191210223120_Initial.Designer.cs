...
namespace Prime.Migrations
{
    ...
    [Migration("20191210223120_Initial")]
            ...
            modelBuilder.Entity("Prime.Models.College", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = (short)1,
                            CreatedTimeStamp = new DateTime(2019, 12, 10, 14, 31, 19, 121, DateTimeKind.Local).AddTicks(5630),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "College of Physicians and Surgeons of BC (CPSBC)",
                            Prefix = "91",
                            UpdatedTimeStamp = new DateTime(2019, 12, 10, 14, 31, 19, 121, DateTimeKind.Local).AddTicks(5630),
