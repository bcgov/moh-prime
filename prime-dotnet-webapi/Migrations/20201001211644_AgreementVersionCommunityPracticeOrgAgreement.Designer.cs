...
namespace Prime.Migrations
{
    ...
    [Migration("20201001211644_AgreementVersionCommunityPracticeOrgAgreement")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prime.Models.AgreementVersion", b =>
                {
                    ...
                    b.Property<int>("AgreementVersionType")
                        .HasColumnType("integer");
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("AgreementVersion");
                });
            ...
            modelBuilder.Entity("Prime.Models.CommunityPharmacistAgreement", b =>
                {
                    b.HasBaseType("Prime.Models.AgreementVersion");

                    b.ToTable("AgreementVersion");

                    b.HasDiscriminator().HasValue("CommunityPharmacistAgreement");
...
",
            ...
            modelBuilder.Entity("Prime.Models.CommunityPracticeOrgAgreement", b =>
                {
                    b.HasBaseType("Prime.Models.AgreementVersion");

                    b.ToTable("AgreementVersion");

                    b.HasDiscriminator().HasValue("CommunityPracticeOrgAgreement");

                    b.HasData(
                        new
                        {
                            Id = 11,
                            AgreementVersionType = 4,
                            CreatedTimeStamp = new DateTimeOffset(new DateTime(2019, 9, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -7, 0, 0, 0)),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            EffectiveDate = new DateTimeOffset(new DateTime(2020, 9, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -7, 0, 0, 0)),
...
",
            ...
            modelBuilder.Entity("Prime.Models.OboAgreement", b =>
                {
                    b.HasBaseType("Prime.Models.AgreementVersion");

                    b.ToTable("AgreementVersion");

                    b.HasDiscriminator().HasValue("OboAgreement");
...
",
            ...
            modelBuilder.Entity("Prime.Models.RegulatedUserAgreement", b =>
                {
                    b.HasBaseType("Prime.Models.AgreementVersion");

                    b.ToTable("AgreementVersion");

                    b.HasDiscriminator().HasValue("RegulatedUserAgreement");
