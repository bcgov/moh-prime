...
namespace Prime.Migrations
{
    ...
    [Migration("20191204004300_Initial")]
            ...
            modelBuilder.Entity("Prime.Models.College", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = (short)1,
                            CreatedTimeStamp = new DateTime(2019, 12, 3, 16, 42, 59, 701, DateTimeKind.Local).AddTicks(7257),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "College of Physicians and Surgeons of BC (CPSBC)",
                            Prefix = "91",
                            UpdatedTimeStamp = new DateTime(2019, 12, 3, 16, 42, 59, 701, DateTimeKind.Local).AddTicks(7257),
