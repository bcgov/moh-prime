...
namespace Prime.Migrations
{
    ...
    [Migration("20191125220213_AddEnrolmentCertificate")]
            ...
            modelBuilder.Entity("Prime.Models.College", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = (short)1,
                            CreatedTimeStamp = new DateTime(2019, 11, 25, 14, 2, 13, 81, DateTimeKind.Local).AddTicks(1336),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "College of Physicians and Surgeons of BC (CPSBC)",
                            Prefix = "91",
                            UpdatedTimeStamp = new DateTime(2019, 11, 25, 14, 2, 13, 81, DateTimeKind.Local).AddTicks(1336),
