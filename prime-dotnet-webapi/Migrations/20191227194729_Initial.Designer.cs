...
namespace Prime.Migrations
{
    ...
    [Migration("20191227194729_Initial")]
            ...
            modelBuilder.Entity("Prime.Models.College", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = (short)1,
                            CreatedTimeStamp = new DateTime(2019, 12, 27, 11, 47, 28, 334, DateTimeKind.Local).AddTicks(9573),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "College of Physicians and Surgeons of BC (CPSBC)",
                            Prefix = "91",
                            UpdatedTimeStamp = new DateTime(2019, 12, 27, 11, 47, 28, 334, DateTimeKind.Local).AddTicks(9573),
            ...
            modelBuilder.Entity("Prime.Models.DefaultPrivilege", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrivilegeId = 18,
                            LicenseCode = (short)30,
                            CreatedTimeStamp = new DateTime(2019, 12, 27, 11, 47, 28, 634, DateTimeKind.Local).AddTicks(9323),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            UpdatedTimeStamp = new DateTime(2019, 12, 27, 11, 47, 28, 634, DateTimeKind.Local).AddTicks(9323),
                            UpdatedUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Prime.Models.Privilege", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTimeStamp = new DateTime(2019, 12, 27, 11, 47, 28, 632, DateTimeKind.Local).AddTicks(3931),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Update Claims History",
                            PrivilegeGroupId = 1,
                            TransactionType = "TAC",
                            UpdatedTimeStamp = new DateTime(2019, 12, 27, 11, 47, 28, 632, DateTimeKind.Local).AddTicks(3931),
                            UpdatedUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Prime.Models.PrivilegeGroup", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTimeStamp = new DateTime(2019, 12, 27, 11, 47, 28, 631, DateTimeKind.Local).AddTicks(9106),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Submit and Access Claims",
                            UpdatedTimeStamp = new DateTime(2019, 12, 27, 11, 47, 28, 631, DateTimeKind.Local).AddTicks(9106),
                            UpdatedUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
