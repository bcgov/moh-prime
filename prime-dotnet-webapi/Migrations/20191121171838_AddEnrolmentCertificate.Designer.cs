...
namespace Prime.Migrations
{
    ...
    [Migration("20191121171838_AddEnrolmentCertificate")]
    partial class AddEnrolmentCertificate
    {
            ...
            modelBuilder.Entity("Prime.Models.College", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = (short)1,
                            CreatedTimeStamp = new DateTime(2019, 11, 21, 9, 18, 37, 667, DateTimeKind.Local).AddTicks(5155),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "College of Physicians and Surgeons of BC (CPSBC)",
                            Prefix = "91",
                            UpdatedTimeStamp = new DateTime(2019, 11, 21, 9, 18, 37, 667, DateTimeKind.Local).AddTicks(5155),
