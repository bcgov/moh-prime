...
namespace Prime.Migrations
{
    ...
    [Migration("20191031214503_AddStatusReasons")]
    partial class AddStatusReasons
    {
            ...
            modelBuilder.Entity("Prime.Models.College", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = (short)1,
                            CreatedTimeStamp = new DateTime(2019, 10, 31, 14, 45, 2, 558, DateTimeKind.Local).AddTicks(9802),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "College of Physicians and Surgeons of BC (CPSBC)",
                            Prefix = "91",
                            UpdatedTimeStamp = new DateTime(2019, 10, 31, 14, 45, 2, 558, DateTimeKind.Local).AddTicks(9802),
