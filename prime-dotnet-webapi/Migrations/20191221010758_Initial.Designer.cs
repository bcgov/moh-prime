...
namespace Prime.Migrations
{
    ...
    [Migration("20191221010758_Initial")]
            ...
            modelBuilder.Entity("Prime.Models.DefaultPrivilege", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrivilegeId = 18,
                            LicenseCode = (short)30,
                            CreatedTimeStamp = new DateTime(2019, 12, 20, 17, 7, 58, 146, DateTimeKind.Local).AddTicks(623),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            UpdatedTimeStamp = new DateTime(2019, 12, 20, 17, 7, 58, 146, DateTimeKind.Local).AddTicks(623),
                            UpdatedUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Prime.Models.Privilege", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTimeStamp = new DateTime(2019, 12, 20, 17, 7, 58, 142, DateTimeKind.Local).AddTicks(8425),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Update Claims History",
                            PrivilegeGroupId = 1,
                            TransactionType = "TAC",
                            UpdatedTimeStamp = new DateTime(2019, 12, 20, 17, 7, 58, 142, DateTimeKind.Local).AddTicks(8425),
                            UpdatedUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Prime.Models.PrivilegeGroup", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTimeStamp = new DateTime(2019, 12, 20, 17, 7, 58, 142, DateTimeKind.Local).AddTicks(2594),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Submit and Access Claims",
                            UpdatedTimeStamp = new DateTime(2019, 12, 20, 17, 7, 58, 142, DateTimeKind.Local).AddTicks(2594),
                            UpdatedUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
