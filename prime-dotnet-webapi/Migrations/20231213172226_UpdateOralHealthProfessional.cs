    ...
    public partial class UpdateOralHealthProfessional : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 118, "Non-Practising Denturist", 5 },
                    { 93, "Full Certified Dental Assisant", 1 },
                    { 94, "Limited Certified Dental Assistant", 2 },
                    { 95, "Non-Practising Certified Dental Assistant", 3 },
                    { 96, "Temporary Certified Dental Assistant", 4 },
                    { 97, "Registered Dental Hygienist", 1 },
                    { 98, "Dental Hygiene Practitioner", 2 },
                    { 99, "Non-Practising Dental Hygienist", 3 },
                    { 100, "Temporary Dental Hygienist", 4 },
                    { 101, "Dental Technician", 1 },
                    { 102, "Student Dental Technician", 2 },
                    { 103, "Non-Practising Dental Technician", 3 },
                    { 119, "Temporary Denturist", 6 },
                    { 104, "Temporary Dental Technician", 4 },
                    { 106, "Full Dentist", 1 },
                    { 107, "Limited (Academic) Dentist", 2 },
                    { 108, "Limited (Armed Services or Government) Dentist", 3 },
                    { 109, "Limited (Education & Volunteer) Dentist", 4 },
                    { 110, "Limited (Restricted-to-Specialty) Dentist", 5 },
                    { 111, "Student Dentist", 6 },
                    { 112, "Non-Practising Dentist", 7 },
                    { 113, "Temporary Dentist", 8 },
                    { 114, "Full Denturist", 1 },
                    { 115, "Limited Denturist", 2 },
                    { 117, "Student Denturist", 4 },
                    { 105, "Dental Therapist", 1 },
                    { 116, "Limited (Grandfathered) Denturist", 3 }
                });
