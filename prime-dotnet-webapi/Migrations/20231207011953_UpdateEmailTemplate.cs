    ...
    public partial class UpdateEmailTemplate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 7,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "The email will be triggered when a site is approved.", "To: MOH", "[{siteId}] Site Registration Approved", "<p>@Model.DoingBusinessAs with SiteID @Model.Pec has been approved by the Ministry of Health for PharmaNet access. Please notify the PharmaNet software vendor for this site and complete any remaining tasks to activate the site.</p><p>Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "HIBC Site Submission", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 9,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "The email will be triggered when SA uploads a business license and click 'Save and Continue'.", "To: Adjudicator", "Site Business Licence Uploaded", "<p> A user has uploaded a business licence to their PharmaNet site registration. @if (!string.IsNullOrWhiteSpace(Model.Url)) { @(\"To access the Business Licence, click this\") <a href=\"@Model.Url\" target=\"_blank\">link</a>@(\".\") } </p> Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Business Licence Upload", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 13,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "The email will be triggered when a SA or AU submits a site.", "To: MOH, cc: PRIME Support", "Priority! New Pharmacy - [Care Setting]", "<p> A new PharmaNet site registration has been received. See the attached registration and organization agreement for more information. @if (!string.IsNullOrWhiteSpace(Model.Url)) { @(\"To access the Business Licence, click this\") <a href=\"@Model.Url\" target=\"_blank\">link</a>@(\".\") } <br/><br/> Thank you, <br/><br/> PRIME Support team <br/><br/> Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Site Registration Submission", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 14,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "The email will be triggered when PRIME admin approves a organization claim.", "To: New SA", "Organization Claim was Approved", "Your claim of the organization @Model.OrganizationName, which the site with SiteID/PEC @Model.ProvidedSiteId is part of, has been approved.  You may now access to site registration for this organization. < br >< br >You must sign the Organization Agreement before you will be able to update or add any sites.This is a click-to-accept online signature that is linked to your BC Services Card identity.If you are not qualified to accept legal agreements on behalf of your organization, or if your organization does not allow you to sign online agreements, please contact PRIMESupport @gov.bc.ca for further guidance before you proceed further.", "Organization Claim Approval Notification", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });

            migrationBuilder.UpdateData(
                table: "EmailTemplate",
                keyColumn: "Id",
                keyValue: 15,
                columns: new[] { "Description", "Recipient", "Subject", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "The email will be triggered when an adjudicator send notification from site overview page for Community Pharmacy or Device Provider site.", "To: Lori.Haggstrom@gov.bc.ca", "PRIME Site Registration review complete", "Site Reviewed Notification", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 19,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "Enrollee send email notification for the absence entry.", "To: User entered email", "PRIME Absence Notification", "This is an automated generated email from PRIME. <br/> <br/> @(Model.FirstName + \" \" +  Model.LastName + \" is going to be absent \") @if (Model.End.HasValue) {@(\"from \" + Model.Start.ToShortDateString() + \" to \" + Model.End.Value.ToShortDateString() + \".  Please consider deactivating the user during this period. Any access during this period by the user will be considered as an unauthorized access.\")} else {@(\"indefinitely, starting \" + Model.Start.ToShortDateString() + \". Please deactivate the user on the start date. Any access during this period by the user will be considered as an unauthorized access.\")} Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Enrollee Absence Notification", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 22,
                columns: new[] { "Description", "Recipient", "Subject", "Template", "TemplateName", "UpdatedTimeStamp" },
                values: new object[] { "Enrollee send out the Provisioner Link Email.", "To: Provisioner, CC: Enrollee", "New Access Request", "To: Whom it may concern, <br/> <br/> @Model.EnrolleeFullName has been approved for <strong>device provider access to PharmaNet.</strong> Their PharmaNet access account can now be set up in your local software. You must include their <strong>Global PharmaNet ID (GPID)</strong> on their account profile. You can access their GPID at the link below. <br/> <br/> <a href=\"@Model.TokenUrl\">@Model.TokenUrl</a> <br/> <strong>This link will expire after @Model.ExpiresInDays days</strong>. <br/> <br/> Please connect by phone or email if you have any questions. <br/><br/>Thank you, <br/><br/>PRIME Support team <br/>1-844-397-7463<br/> PRIMESupport@gov.bc.ca", "Device Provider Notification", new DateTimeOffset(new DateTime(2023, 10, 27, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
        }
