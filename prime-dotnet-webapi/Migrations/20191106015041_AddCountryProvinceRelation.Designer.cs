...
namespace Prime.Migrations
{
    ...
    [Migration("20191106015041_AddCountryProvinceRelation")]
    partial class AddCountryProvinceRelation
    {
            ...
            modelBuilder.Entity("Prime.Models.College", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = (short)1,
                            CreatedTimeStamp = new DateTime(2019, 11, 5, 17, 50, 40, 20, DateTimeKind.Local).AddTicks(3667),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "College of Physicians and Surgeons of BC (CPSBC)",
                            Prefix = "91",
                            UpdatedTimeStamp = new DateTime(2019, 11, 5, 17, 50, 40, 20, DateTimeKind.Local).AddTicks(3667),
