...
namespace Prime.Migrations
{
    ...
    [Migration("20191210033436_UpdatedEnrolleeProfileCompleted")]
    partial class UpdatedEnrolleeProfileCompleted
    {
            ...
            modelBuilder.Entity("Prime.Models.College", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = (short)1,
                            CreatedTimeStamp = new DateTime(2019, 12, 9, 19, 34, 35, 261, DateTimeKind.Local).AddTicks(8350),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "College of Physicians and Surgeons of BC (CPSBC)",
                            Prefix = "91",
                            UpdatedTimeStamp = new DateTime(2019, 12, 9, 19, 34, 35, 261, DateTimeKind.Local).AddTicks(8350),
