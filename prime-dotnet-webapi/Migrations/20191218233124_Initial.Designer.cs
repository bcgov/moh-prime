...
namespace Prime.Migrations
{
    ...
    [Migration("20191218233124_Initial")]
            ...
            modelBuilder.Entity("Prime.Models.College", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = (short)1,
                            CreatedTimeStamp = new DateTime(2019, 12, 18, 15, 31, 23, 533, DateTimeKind.Local).AddTicks(5354),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "College of Physicians and Surgeons of BC (CPSBC)",
                            Prefix = "91",
                            UpdatedTimeStamp = new DateTime(2019, 12, 18, 15, 31, 23, 533, DateTimeKind.Local).AddTicks(5354),
            ...
            modelBuilder.Entity("Prime.Models.DefaultPrivilege", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrivilegeId = 18,
                            LicenseCode = (short)30,
                            CreatedTimeStamp = new DateTime(2019, 12, 18, 15, 31, 23, 808, DateTimeKind.Local).AddTicks(2439),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            UpdatedTimeStamp = new DateTime(2019, 12, 18, 15, 31, 23, 808, DateTimeKind.Local).AddTicks(2439),
                            UpdatedUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Prime.Models.Privilege", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTimeStamp = new DateTime(2019, 12, 18, 15, 31, 23, 805, DateTimeKind.Local).AddTicks(6021),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Update Claims History",
                            PrivilegeGroupId = 1,
                            TransactionType = "TAC",
                            UpdatedTimeStamp = new DateTime(2019, 12, 18, 15, 31, 23, 805, DateTimeKind.Local).AddTicks(6021),
                            UpdatedUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Prime.Models.PrivilegeGroup", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTimeStamp = new DateTime(2019, 12, 18, 15, 31, 23, 805, DateTimeKind.Local).AddTicks(935),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Submit and Access Claims",
                            UpdatedTimeStamp = new DateTime(2019, 12, 18, 15, 31, 23, 805, DateTimeKind.Local).AddTicks(935),
                            UpdatedUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Prime.Models.StatusReason", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedTimeStamp = new DateTime(2019, 12, 18, 15, 31, 23, 533, DateTimeKind.Local).AddTicks(5354),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Could not verify College Licence with PharmaNet",
                            UpdatedTimeStamp = new DateTime(2019, 12, 18, 15, 31, 23, 533, DateTimeKind.Local).AddTicks(5354),
                            UpdatedUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
