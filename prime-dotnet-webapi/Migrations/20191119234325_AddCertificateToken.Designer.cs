...
namespace Prime.Migrations
{
    ...
    [Migration("20191119234325_AddCertificateToken")]
    partial class AddCertificateToken
    {
            ...
            modelBuilder.Entity("Prime.Models.College", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = (short)1,
                            CreatedTimeStamp = new DateTime(2019, 11, 19, 15, 43, 25, 305, DateTimeKind.Local).AddTicks(7131),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "College of Physicians and Surgeons of BC (CPSBC)",
                            Prefix = "91",
                            UpdatedTimeStamp = new DateTime(2019, 11, 19, 15, 43, 25, 305, DateTimeKind.Local).AddTicks(7131),
