...
namespace Prime.Migrations
{
    ...
    [Migration("20191217225649_Initial")]
            ...
            modelBuilder.Entity("Prime.Models.College", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = (short)1,
                            CreatedTimeStamp = new DateTime(2019, 12, 17, 14, 56, 48, 574, DateTimeKind.Local).AddTicks(7821),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "College of Physicians and Surgeons of BC (CPSBC)",
                            Prefix = "91",
                            UpdatedTimeStamp = new DateTime(2019, 12, 17, 14, 56, 48, 574, DateTimeKind.Local).AddTicks(7821),
            ...
            modelBuilder.Entity("Prime.Models.DefaultPrivilege", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrivilegeId = 18,
                            LicenseCode = (short)30,
                            CreatedTimeStamp = new DateTime(2019, 12, 17, 14, 56, 48, 866, DateTimeKind.Local).AddTicks(8598),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            UpdatedTimeStamp = new DateTime(2019, 12, 17, 14, 56, 48, 866, DateTimeKind.Local).AddTicks(8598),
                            UpdatedUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Prime.Models.Privilege", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTimeStamp = new DateTime(2019, 12, 17, 14, 56, 48, 864, DateTimeKind.Local).AddTicks(2449),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Description = "Update Claims History",
                            PrivilegeGroupId = 1,
                            TransactionType = "TAC",
                            UpdatedTimeStamp = new DateTime(2019, 12, 17, 14, 56, 48, 864, DateTimeKind.Local).AddTicks(2449),
                            UpdatedUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Prime.Models.PrivilegeGroup", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTimeStamp = new DateTime(2019, 12, 17, 14, 56, 48, 863, DateTimeKind.Local).AddTicks(6964),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Submit and Access Claims",
                            UpdatedTimeStamp = new DateTime(2019, 12, 17, 14, 56, 48, 863, DateTimeKind.Local).AddTicks(6964),
                            UpdatedUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
