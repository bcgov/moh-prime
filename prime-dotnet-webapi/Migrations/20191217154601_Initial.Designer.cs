...
namespace Prime.Migrations
{
    ...
    [Migration("20191217154601_Initial")]
            ...
            modelBuilder.Entity("Prime.Models.College", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = (short)1,
                            CreatedTimeStamp = new DateTime(2019, 12, 17, 7, 46, 0, 767, DateTimeKind.Local).AddTicks(3380),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "College of Physicians and Surgeons of BC (CPSBC)",
                            Prefix = "91",
                            UpdatedTimeStamp = new DateTime(2019, 12, 17, 7, 46, 0, 767, DateTimeKind.Local).AddTicks(3380),
