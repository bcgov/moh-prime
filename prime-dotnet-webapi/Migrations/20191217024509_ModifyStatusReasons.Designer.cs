...
namespace Prime.Migrations
{
    ...
    [Migration("20191217024509_ModifyStatusReasons")]
    partial class ModifyStatusReasons
    {
            ...
            modelBuilder.Entity("Prime.Models.College", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = (short)1,
                            CreatedTimeStamp = new DateTime(2019, 12, 16, 18, 45, 9, 116, DateTimeKind.Local).AddTicks(9180),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "College of Physicians and Surgeons of BC (CPSBC)",
                            Prefix = "91",
                            UpdatedTimeStamp = new DateTime(2019, 12, 16, 18, 45, 9, 116, DateTimeKind.Local).AddTicks(9180),
