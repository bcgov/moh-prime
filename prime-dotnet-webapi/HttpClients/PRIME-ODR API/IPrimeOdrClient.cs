...
namespace Prime.HttpClients
{
    ...
    {
        /// <summary>
        /// Calls external PRIME-ODR web service and retrieves latest logs as <c>Logs</c>
        /// and <c>ExistsMoreLogs</c> (using C# 7.0 tuple syntax), the latter indicating
        /// whether the PRIME-ODR web service indicated there are more logs that can be retrieved
        /// </summary>
