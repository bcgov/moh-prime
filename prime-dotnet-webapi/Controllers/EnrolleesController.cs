        ...
        public async Task<ActionResult<IEnumerable<Enrollee>>> GetEnrollees([FromQuery] EnrolleeSearchOptions searchOptions)
        {
            ...
            else
            {
                ...
                if (enrollee != null)
                {
                    ...
                    QRCodeData qrCodeData = qrGenerator.CreateQrCode("https://prime-agent-dev.pathfinder.gov.bc.ca?c_i=", QRCodeGenerator.ECCLevel.Q);
