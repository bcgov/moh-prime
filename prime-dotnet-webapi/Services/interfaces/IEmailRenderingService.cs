...
namespace Prime.Services.EmailInternal
{
    public interface IEmailRenderingService
    {
        ...
        Task<Email> RenderHealthAuthoritySiteApprovedEmailAsync(SiteApprovalEmailViewModel viewModel, int siteId);
        ...
        Task<Email> RenderSiteRegistrationSubmissionEmailAsync(LinkedEmailViewModel viewModel, CareSettingType careSettingCode, int siteId, bool isNew = false);
        Task<Email> RenderSiteReviewedNotificationEmailAsync(SiteReviewedEmailViewModel viewModel);
        Task<Email> RenderOrgClaimApprovalNotificationEmailAsync(string newSigningAuthorityEmail, OrgClaimNotificationViewModel viewModel);
        Task<Email> RenderOrgClaimDenialNotificationEmailAsync(string newSigningAuthorityEmail, OrgClaimNotificationViewModel viewModel);
