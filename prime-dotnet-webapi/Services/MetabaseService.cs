...
namespace Prime.Services
{
    public class MetabaseService : IMetabaseService
    {
        ...
        public string BuildMetabaseEmbeddedUrl()
        {
            ...
            return Url.Combine(PrimeEnvironment.Current.MetabaseApi.Url, "embed/dashboard", token)
        ...
        private string BuildMetabaseSecurityToken()
        {
            ...
            {
               { "resource", new { dashboard = PrimeEnvironment.Current.MetabaseApi.DashboardId } },
        ...
        {
            var securityKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(PrimeEnvironment.Current.MetabaseApi.Key));
