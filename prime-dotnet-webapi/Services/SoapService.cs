...
namespace Prime.Services
{
    ...
    public class SoapService : ISoapService
    {
        ...
        private PlrProvider ReadDistributionMessage(string messageContent)
        {
            ...
            const string nonCollegeIdXPathExpr = "not (@root='2.16.840.1.113883.3.40.2.8') and not (@root='2.16.840.1.113883.3.40.2.11') and not (@root='2.16.840.1.113883.3.40.2.3')";
