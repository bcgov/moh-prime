...
public class AutoMapping : Profile
{
    public AutoMapping()
    {
        ...
        CreateMap<PlrProvider, PlrViewModel>()
            .ForMember(dest => dest.ProviderRoleType, opt => opt.MapFrom(src => src.ProviderRole.Name))
            .ForMember(dest => dest.StatusReasonCode, opt => opt.MapFrom(src => src.StatusReason.Name))
