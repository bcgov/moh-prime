...
public class AutoMapping : Profile
{
    public AutoMapping()
    {
        ...
        CreateMap<Enrollee, EnrolleeListViewModel>()
            ...
            .ForMember(dest => dest.RequiresConfirmation, opt => opt.MapFrom(src => src.Submissions.OrderByDescending(s => s.CreatedDate).FirstOrDefault().Confirmed == false && src.PreviousStatus.IsType(StatusType.RequiresToa)))
