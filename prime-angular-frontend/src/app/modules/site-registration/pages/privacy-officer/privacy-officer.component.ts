...
export class PrivacyOfficerComponent implements OnInit, IPage, IForm {
  ...
  public onSubmit() {
    ...
    if (this.formUtilsService.checkValidity(this.form)) {
      ...
      if (updateParty.userId !== '00000000-0000-0000-0000-000000000000') {
        // Party is same as signing authority, patch location privacyOfficerId
        ...
        if (updateParty.id === 0) {
          ...
          this.partyResource.createParty(updateParty)
            .subscribe((party: Party) => {
              // Patch location with created privacyOfficerId
  ...
  private patchLocation(privacyOfficerId: number) {
