...
import { AgreementTypePaperEnrolment, AgreementTypeNameMapPaperEnrolment } from '@shared/enums/agreement-type.enum';
...
export class UploadPageComponent extends AbstractEnrolmentPage implements OnInit {
  ...
  public AgreementTypeNameMapPaperEnrolment = AgreementTypeNameMapPaperEnrolment;
  ...
  constructor(
    ...
    this.documentGuids = [];
    this.agreementTypes = EnumUtils.values(AgreementTypePaperEnrolment);
