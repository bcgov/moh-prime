...
@Component({
  selector: 'app-enrollee-email-notification-list-page',
  templateUrl: './enrollee-email-notification-list-page.component.html',
  styleUrls: ['./enrollee-email-notification-list-page.component.scss']
})
export class EnrolleeEmailNotificationListPageComponent implements OnInit {
