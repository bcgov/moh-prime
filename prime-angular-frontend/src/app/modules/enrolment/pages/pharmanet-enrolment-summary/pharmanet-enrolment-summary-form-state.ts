...
import { NextStepsEnrolmentForm } from '../next-steps/next-steps-form.model';

@Injectable({
  providedIn: 'root'
})
export class PharmanetEnrolmentSummaryFormState extends AbstractFormState<NextStepsEnrolmentForm> {
  public constructor(
