...
import { CloseSiteComponent } from './components/dialogs/content/close-site-note/close-site-note.component';
import { OpenSiteNoteComponent } from './components/dialogs/content/open-site-note/open-site-note.component';
