...
export class CollectionNoticeService {
  ...
  public get ContentToRender(): string {
    return `<p>
        ...
        (FOIPPA) and s. 22(1)(b) of the Pharmaceutical Services Act <b>for the purpose of managing your access to, and use of,
        PharmaNet.*</b>&nbsp;&nbsp;If you have any questions about the collection or use of this information, contact
      </p>
      <p>
      ...
      <p>
        <small>* Added 14 Sept 2023</small>
      </p>
      `;
  }
}
