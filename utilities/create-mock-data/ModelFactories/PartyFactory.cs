...
//            RuleFor(x => x.Id, () => IdCounter++);
            ...
            // Using `f.Random.String`, may get errors like `System.Text.EncoderFallbackException: Unable to translate Unicode character \\uDF4D at index 4 to specified code page.`
            RuleFor(x => x.HPDID, f => f.Random.String2(40));
