    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (var i = 0; i < siteList.Count; i++)
            {
                ...
                writer.WriteLine("\tINSERT INTO public.\"Site\" (\"CreatedUserId\", \"CreatedTimeStamp\", \"UpdatedUserId\", \"UpdatedTimeStamp\", \"PEC\", \"Completed\", \"DoingBusinessAs\", \"OrganizationId\", \"OrganizationId\", \"Status\") "
