...
zap.sh -daemon -host 0.0.0.0 -port 8080 -config api.addrs.addr.name=.* -config api.addrs.addr.regex=true -config spider.maxDuration=1 -addonupdate -addoninstall pscanrulesBeta > /dev/null 2>&1 
