...
# For local testing
#COPY ../ ./moh-prime
ENTRYPOINT [ "/usr/local/openjdk-8/bin/java -jar $HOME/agent/agent.jar -jnlpUrl http://jenkins-prod/computer/code-tests/slave-agent.jnlp -secret c598ca95983a9f6df4d06cc7f770b0d1ea404b806851f1a7f1066d89515c2c12 -workDir /home/jenkins" ]
