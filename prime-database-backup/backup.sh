...
function databaseBackup() {
    ...
    # Backup Mongo
    mongodump --host=${MONGO_HOST} --port=27017 --username=${MONGODB_USER} --password="${MONGODB_ADMIN_PASSWORD}" --out=${backup_dir}/mongodump-${MONGODB_DATABASE}-${timestamp}.backup --authenticationDatabase admin
