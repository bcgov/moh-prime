...
namespace PrimeTests.Services
{
    public class DefaultEnrolleeServiceTests : BaseServiceTests<DefaultEnrolleeService>
    {
        ...
        public DefaultEnrolleeServiceTests() : base(new object[] { new AutomaticAdjudicationServiceMock(), new EmailServiceMock(), new PrivilegeServiceMock(), new TermsOfAccessServiceMock() })
        { }
